...
export default () => {
  ...
  return (
    <div className="flex items-center justify-between px-6 py-4 bg-indigo-800 md:flex-shrink-0 md:w-56 md:justify-center">
      ...
      <div className="relative md:hidden">
        <svg
          ...
          className="w-6 h-6 text-black cursor-pointer fill-current"

...
export default () => {
  ...
  return (
    <div className="flex items-center justify-between w-full p-4 text-sm bg-white border-b md:py-0 md:px-12 d:text-md">
      <div className="mt-1 mr-4">{auth.user.email}</div>
      <div className="relative">
        ...
        >
          <div className="mr-1 text-gray-800 whitespace-nowrap group-hover:text-indigo-600 focus:text-indigo-600">
            ...
            {/* <span className="ml-1 md:inline">{auth.user.last_name}</span> */}
          </div>
          <Icon
            className="w-5 h-5 text-gray-800 fill-current group-hover:text-green-900 focus:text-green-600"
            name="cheveron-down"
          />
        </div>
